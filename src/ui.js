...
//Should i add person up here in order to switch between imperialswitch true/false
  ...
  $("#calculate").click(function () {
    ...
    var person = new Person({weight: w, height: h, imperialswitch: i}); //I have to switch here between true/false manually in order to calculate with metrics/imperial in the browser
